...
var RegistroDiaPersonal = function (data) {
  ...
  this.init = function (data) {
    if (data) {
      var _data$fecha_dia, _data$dni_usuario, _data$dni_personal;
  ...
  this.getRegistrosDia = function () {
    ...
    return $.when(_DB_HANDLER.listarFiltro(storeName, {
      indexes: "fecha_dia,tipo_registro,idempresa",
  ...
  this.eliminarRegistro = function ({
    ...
    return $.when(_DB_HANDLER.eliminar(storeName, {
      index: "fecha_dia,dni_personal,idempresa",
      value: [this.fecha_dia, this.dni_personal, this.idempresa]
    }, objRegistro => {
      return objRegistro.numero_acceso == numero_acceso && objRegistro.tipo_registro === tipo_registro;
    }));
  };

  this.obtenerUltimoMovimientoAsistencia = function () {
    return $.when(_DB_HANDLER.listarFiltro(storeName, {
      "indexes": "fecha_dia,dni_personal,idempresa",
      "values": [this.fecha_dia, this.dni_personal, this.idempresa]
    }));
  };

  this.registrarAsistencia = function ({
    nombres_apellidos,
    tipo_registro,
    numero_acceso,
    latitud,
  ...
  this.marcarRegistrosParaEnvio = function ({
    pareados
  }) {
    return $.when(_DB_HANDLER.actualizar(storeName, "=", "fecha_dia,dni_personal,idempresa", [this.fecha_dia, this.dni_personal, this.idempresa], null, {
      pareados: pareados
    }));
  };
  ...
  this.marcarRegistrosAsistenciaEnviados = function ({
    estado_envio
  }) {
